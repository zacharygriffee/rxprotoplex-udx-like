...
import {filter, fromEvent, ReplaySubject, Subject, switchMap, take, takeUntil} from "rxjs";
import {Duplex} from "streamx";
import b4a, {from} from "b4a";
...
export class UDXStream extends Duplex {
    ...
    connect(socket, remoteId, port, host, opts = {}) {
        ...
        console.log("Listening for data", {
            channel: `${this.localPort}\$\$${this.id}`,
            stream: this,
            socket: this.socket,
            id: this.id,
            port: this.localPort,
        ...
        console.debug("Stream added to socket:", this);
    ...
    //     }
    //     if (!host) host = ""; // Default host logic.
    //     const family = 4;
    //
